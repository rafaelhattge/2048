 ...
 */
function Piece(value, board, x, y, id) {
    this.value = value;
    this.board = board;
...
Piece.prototype.render = function () {
    ...
    roundedRectangle(this.x + 5, this.y + 5, this.size - 10, this.size - 10, value, this.size, this.id);
}
...
function roundedRectangle(x, y, w, h, value, size, id) {
    radius = w / 20;
    var r = x + w;
    var b = y + h;
    var fillStyle;
