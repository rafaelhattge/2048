...
//TEST BOARD
// var piece1 = new Piece(2, board, 0, 0, 1);
// var piece2 = new Piece(2, board, 1, 0, 2);
// var piece3 = new Piece(2, board, 2, 0, 3);
// var piece4 = new Piece(2, board, 3, 0, 4);
...
function gameStart() {
    ...
    // board.tiles = testBoard; //TEST BOARD, REMOVE
    tiles = board.tiles;
    score = 0;
...
function addRandomPiece(board, pieces) {
    ...
    while (piecesPlaced < pieces) {
        ...
        if (tiles[x][y] === null) {
            var piece = new Piece(value, board, y, x, ++pieceId);
            tiles[x][y] = piece;
            piecesPlaced++;
        }
    }
